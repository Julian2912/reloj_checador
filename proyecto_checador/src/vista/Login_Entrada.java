...
private  AsignaIcon asignaicon;
    ...
    public void asignar(String name,String horaE,String horaLLe,String depart,String eTurno){
        LocalTime ingreso = LocalTime.parse(horaE);
        LocalTime salida =  ingreso.plusHours(8);
        jLabel4.setText(name);
        jLabel6.setText("["+horaE+" - "+ salida+"]");
        jLabel8.setText(depart);
        jLabel10.setText("Hora Registrada: "+horaLLe+" hrs");
        jLabel9.setText(eTurno);            
