...
public class ChequeoXDiaDAO {
     public void registrarChequeoXDia(ChequeoXDiaVO h) 
 {
  ...
  try {
   ...
   estatuto.executeUpdate("INSERT INTO empleado.chequeoxdia (CodigoEmpleado,FechaLab, Descripcion  )"
   ...
   JOptionPane.showMessageDialog(null, "No se Registro la ChequeoXDiaDAO");
  }
 }
